...
BOT = 'Stop'  # 'Run' - Запущен / 'Pause' (Теущие Ордера Стоят, Новые не ставятся) / 'Stop' - Остановлен. Ордера Удалены

SYMBOL = 'DEL/USDT'     # Торгуемая Пара
VOLUME_BASE = 1000      # Количество исользуемых Средств Базовой Валюты (в абс. значениях)
VOLUME_QUOTE = 50       # Количество исользуемых Средств Базовой Валюты (в абс. значениях)
PART_carrot = 20        # Часть (в %) от общих Используемых Средств для Приманок
